...
class Laporan extends AUTH_Controller
{
	...
	public function index()
	{
		...
		$data['form_kec'] 		= form_dropdown('', $opt, '', 'id="nama_kec" name="kdkec" class="form-control"');
		...
		$data['page'] 			= "Laporan Hasil Presiden";
		$data['judul'] 			= "Laporan";
		$data['deskripsi'] 		= "Laporan Hasil Pemilihan Presiden";
	...
	public function cetakPDF()
	{
		...
		$mpdf->WriteHTML($data);
		$mpdf->Output('./assets/excel/laporan_Presiden_' . $this->session->userdata('thn_data') . '.pdf', 'I');
	}
	...
	public function export()
	{
		...
		$objWriter->save('./assets/excel/laporan_Presiden_' . $this->session->userdata('thn_data') . '.xlsx');

		$this->load->helper('download');
		force_download('./assets/excel/laporan_Presiden_' . $this->session->userdata('thn_data') . '.xlsx', NULL);
	}
}
