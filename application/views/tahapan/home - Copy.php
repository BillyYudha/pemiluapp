    ...
    <div class="box-body">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Tahapan Pelaksanaan Presiden</h3>
            </div>
            <div class="panel-body">
                <form id="form-tahapan" class="form-horizontal" method="POST">
                    <table class="">
                        <!-- Tahap 1 -->
                        <tr>
                            <td>Pengelolaan Data Desa Penyelenggara Presiden (input/edit/delete)</td>
                            <td>
                        ...
                        <!-- Tahap 2 -->
                        <tr>
                            <td>Pengelolaan Data Calon Presiden (input/edit/delete)</td>
                            <td>
                        ...
                        <!--  Tahap 3 -->
                        <tr>
                            <td>Pengelolaan Hasil Presiden</td>
                            <td>
